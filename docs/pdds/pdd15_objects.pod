...
An accessor for the attributes of the class. It returns the Hash of
...
value is the name it will have in the class. (This is also sometimes
...
Throws an exception for a nonexistent method.
...
the parent class has, and they both exist depending on what type an
